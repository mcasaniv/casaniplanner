...
export function useAgenda() {
  ...
  const addScheduleEntry = (day: DayOfWeek, materia: any, section: 'morning' | 'afternoon' = 'morning') => {
    setSchedule(prev => [...prev, { id: crypto.randomUUID(), day, materia, section, completedDates: [] }]);
  };
  ...
  const toggleScheduleEntryCompleted = (entryId: string, dateStr: string) => {
